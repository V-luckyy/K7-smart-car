...
/*--------UART2 config--------*/
#define ENABLE_UART2_CLOCK  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2,ENABLE)
#if 1 //PD5、PD6
#define ENABLE_UART2_TX_PIN_CLOCK   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD,ENABLE)
#define ENABLE_UART2_RX_PIN_CLOCK   RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD,ENABLE)
#define UART2_TX_PORT       GPIOD
#define UART2_RX_PORT       GPIOD
#define UART2_TX_PIN        GPIO_Pin_5
#define UART2_RX_PIN        GPIO_Pin_6
#define UART2_TX_Soure      GPIO_PinSource5
#define UART2_RX_Soure      GPIO_PinSource6
#else 
