...
void UART2_Init(u32 bound)
{
    ...
    //对应引脚、对应串口时钟开启
    ENABLE_UART2_TX_PIN_CLOCK;
    ENABLE_UART2_RX_PIN_CLOCK;
    ENABLE_UART2_CLOCK;

    //AF初始化
    GPIO_PinAFConfig(UART2_TX_PORT,UART2_TX_Soure,GPIO_AF_USART2);
    GPIO_PinAFConfig(UART2_RX_PORT,UART2_RX_Soure,GPIO_AF_USART2);
